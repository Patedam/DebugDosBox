...
#if !CDROM_SUPPORT
// Redefine SDL_CD Macros to deactivate cdrom support (SDL_Cd has been removed from SDL2)
#define MSF_TO_FRAMES(M, S, F) 0
...
// Deactivate SDL Cdrom Interface (SDL_Cd has been removed from SDL2)
#if CDROM_SUPPORT
...
#endif // Deactivated SDL_CDRom code
